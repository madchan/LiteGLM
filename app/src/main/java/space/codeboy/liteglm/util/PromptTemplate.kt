    ...
    companion object {
        fun getTemplate(instruction: String, nodeTree: String): String {
            return """
                ...
                # 函数调用 
                - findAndClickById(viewId: String, bound: Rect)：根据ViewId找到要点击的控件并点击它;
                ...
                ```
                {"tool_calls":[{"function":{"name":string,"arguments":\"{"viewId":string,"bound":{"left":int,"top":int,"right":int,"bottom":int}, "text":string}\","done":bool}}]}
                ```
